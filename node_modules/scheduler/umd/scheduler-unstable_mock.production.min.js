...
null===n||-1!==z&&null!==n&&n.length>=z||K&&E?A=!0:!1}function P(){if(l)throw Error("Already flushing work.");if(null!==g){var a=g;l=!0;try{var b=!0;do b=a(!0,k);while(b);b||(g=null);return!0}finally{l=!1}}else return!1}var q=[],t=[],Q=1,m=null,h=3,J=!1,y=!1,D=!1,k=0,g=null,r=null,u=-1,n=null,z=-1,A=!1,l=!1,E=!1,K=!1,N=!1;d.reset=function(){if(l)throw Error("Cannot reset while already flushing work.");k=0;r=g=null;u=-1;n=null;z=-1;E=l=A=!1};d.unstable_IdlePriority=5;d.unstable_ImmediatePriority=1;
d.unstable_LowPriority=4;d.unstable_NormalPriority=3;d.unstable_Profiling=null;d.unstable_UserBlockingPriority=2;d.unstable_advanceTime=function(a){"disabledLog"===console.log.name||N||(k+=a,null!==r&&u<=k&&(r(k),u=-1,r=null))};d.unstable_cancelCallback=function(a){a.callback=null};d.unstable_clearYields=function(){if(null===n)return[];var a=n;n=null;return a};d.unstable_continueExecution=function(){y||J||(y=!0,g=M)};d.unstable_flushAll=function(){if(null!==n)throw Error("Log is not empty. Assert on the log of yielded values before flushing additional work.");
P();if(null!==n)throw Error("While flushing work, something yielded a value. Use an assertion helper to assert on the log of yielded values, e.g. expect(Scheduler).toFlushAndYield([...])");};d.unstable_flushAllWithoutAsserting=P;d.unstable_flushExpired=function(){if(l)throw Error("Already flushing work.");if(null!==g){l=!0;try{g(!1,k)||(g=null)}finally{l=!1}}};d.unstable_flushNumberOfYields=function(a){if(l)throw Error("Already flushing work.");if(null!==g){var b=g;z=a;l=!0;try{a=!0;do a=b(!0,k);
while(a&&!A);a||(g=null)}finally{z=-1,l=A=!1}}};d.unstable_flushUntilNextPaint=function(){if(l)throw Error("Already flushing work.");if(null!==g){var a=g;K=!0;E=!1;l=!0;try{var b=!0;do b=a(!0,k);while(b&&!A);b||(g=null)}finally{l=A=K=!1}}return!1};d.unstable_forceFrameRate=function(){};d.unstable_getCurrentPriorityLevel=function(){return h};d.unstable_getFirstCallbackNode=function(){return p(q)};d.unstable_hasPendingWork=function(){return null!==g};d.unstable_next=function(a){switch(h){case 1:case 2:case 3:var b=
3;break;default:b=h}var c=h;h=b;try{return a()}finally{h=c}};d.unstable_now=function(){return k};d.unstable_pauseExecution=function(){};d.unstable_requestPaint=function(){E=!0};d.unstable_runWithPriority=function(a,b){switch(a){case 1:case 2:case 3:case 4:case 5:break;default:a=3}var c=h;h=a;try{return b()}finally{h=c}};d.unstable_scheduleCallback=function(a,b,c){var e=k;"object"===typeof c&&null!==c?(c=c.delay,c="number"===typeof c&&0<c?e+c:e):c=e;switch(a){case 1:var f=-1;break;case 2:f=250;break;
case 5:f=1073741823;break;case 4:f=1E4;break;default:f=5E3}f=c+f;a={id:Q++,callback:b,priorityLevel:a,startTime:c,expirationTime:f,sortIndex:-1};c>e?(a.sortIndex=c,v(t,a),null===p(q)&&a===p(t)&&(D?(r=null,u=-1):D=!0,r=L,u=k+(c-e))):(a.sortIndex=f,v(q,a),y||J||(y=!0,g=M));return a};d.unstable_setDisableYieldValue=function(a){N=a};d.unstable_shouldYield=O;d.unstable_wrapCallback=function(a){var b=h;return function(){var c=h;h=b;try{return a.apply(this,arguments)}finally{h=c}}};d.unstable_yieldValue=
function(a){"disabledLog"===console.log.name||N||(null===n?n=[a]:n.push(a))}});
})();
